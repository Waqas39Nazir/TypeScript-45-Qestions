...
console.log("Album One Data\n", "Arist Name:", albumOne.artistName, "\n", "Album Title:", albumOne.albumTitle);
console.log("\n");
console.log("Album Two Data\n", "Arist Name:", albumTwo.artistName, "\n", "Album Title:", albumTwo.albumTitle);
console.log("\n");
console.log("Album Three Data\n", "Arist Name:", albumThree.artistName, "\n", "Album Title:", albumThree.albumTitle, "\n", "Album Tracks:", albumThree.tracks);
